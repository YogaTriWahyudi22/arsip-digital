...
<head>
    ...
    <title>Laporan Surat Keterangan - Arsip Digital (Pegawai)</title>
</head>
<body>
    <div class="sidebar">
    ...
    <script type="text/javascript">
        ...
        function submit(){
            ...
            var jns = document.getElementById("jenis");
            var thn = document.getElementById("tahun");
            if(bln.selectedIndex == "" && jns.selectedIndex == "") {
                alert("Pilih Tahun dan Bulan / Jenis Surat Terlebih Dahulu!")
            } else {
