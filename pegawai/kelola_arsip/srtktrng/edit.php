...
<head>
    ...
    <title>Edit Data Surat Keterangan - Arsip Digital (Pegawai)</title>
</head>
<body>
                ...
                <div class="data">
                        <div class="card">
                            <div class="card-header">
                                <h3>
                                    Edit Data <?php echo $sqli['jenis_keterangan'] ?>
                                </h3>
                            </div>
                            <div class="card-body">
                                ...
                                <tr>
                                        ...
                                        <tr>
                                            <td>Pemohon</td>
                                            <td><input type="text" name="pemohon"
                                            value="<?php echo $data['pemohon'] ?>"></td>
                                        </tr>
                                        <tr>
                                            <td>Keperluan</td>
                                            <td><input type="text" name="keperluan"
                                            value="<?php echo $data['keperluan'] ?>"></td>
                                        </tr>
                                        <tr>
                                            <td>Tanggal Surat</td>
                                        ...
                                        <tr>
                                            ...
                                            placeholder="(Boleh dikosongkan jika tidak ada isi)"
                                            value="<?php echo $data['kepala_keluarga'] ?>"></td>
                                        </tr>
                                        <tr>
                                            <td>Tanggungan</td>
                                            <td><input type="text" name="tanggungan"
                                            placeholder="(Boleh dikosongkan jika tidak ada isi)"
                                            value="<?php echo $data['tanggungan'] ?>"></td>
                                        </tr>
                                        <tr>
                                            <td>Yang Meninggal</td>
                                            <td><input type="text" name="yg_meninggal"
                                            placeholder="(Boleh dikosongkan jika tidak ada isi)"
                                            value="<?php echo $data['yg_meninggal'] ?>"></td>
                                        </tr>
                                        <tr>
                                            <td>Keterangan Meninggal</td>
                                            <td><input type="text" name="keterangan_meninggal"
                                            placeholder="(Boleh dikosongkan jika tidak ada isi)"
                                            value="<?php echo $data['keterangan_meninggal'] ?>"></td>
                                        </tr>
                                        <tr>
                                            <td>Ahli Waris</td>
                                            <td><input type="text" name="ahli_waris"
                                            placeholder="(Boleh dikosongkan jika tidak ada isi)"
                                            value="<?php echo $data['ahli_waris'] ?>"></td>
                                        </tr>
                                        <tr>
                                ...
                                <div class="footer">
                                    ...
                                    <a href="data.php?id=<?php echo $sqli['id_jenis_keterangan'] ?>"><label name="back" class="btnnn">Kembali
