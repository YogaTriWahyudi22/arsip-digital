...
// Pengambilan Data dari Database MySQL
$sql = $conn->prepare("SELECT * FROM surat_keputusan WHERE id_surat_keputusan = '$_GET[id]'");
$sql->execute();
$data = $sql->fetch();
...
<head>
    ...
    <title>Edit Data Surat Keputusan - Arsip Digital (Pegawai)</title>
</head>
<body>
                            ...
                            <div class="card-body">
                                ...
                                <table width="100%">
                                    <tr>
                                        ...
                                        value="<?php echo $data['nomor_surat_keputusan'] ?>"></td>
                                    </tr>
                                    <tr>
                                        <td>Tentang</td>
                                        <td><input type="text" name="tentang"
                                        value="<?php echo $data['tentang'] ?>"></td>
                                    </tr>
                                    <tr>
                                        <td>Tanggal Surat</td>
                                    ...
                                    <tr>
                                        ...
                                        value="<?php echo $data['lampiran'] ?>"></td>
                                    </tr>
                                    <tr>
