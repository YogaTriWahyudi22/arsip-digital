...
<head>
    ...
    <meta http-equiv="refresh" content="1; url=srtkptsn.php">
    <link rel="stylesheet" href="style/srtmasuk-print.css">
    <title>Laporan Keseluruhan Surat Keputusan Tahun <?php echo $_GET['tahun'] ?> Bulan <?php echo $bln ?></title>
</head>
<body onload="window.print();">
    ...
    <h1>Laporan Keseluruhan Surat Keputusan<br>Tahun <?php echo $_GET['tahun'] ?> di Bulan <?php echo $bln ?></h1>
    <table class="tbl">
        <tr>
            <td width="20px">No.</td>
    ...
    <?php
        ...
        $sql = $conn->prepare("SELECT * FROM surat_keputusan WHERE MONTH(tanggal_surat)='$_GET[bulan]'
