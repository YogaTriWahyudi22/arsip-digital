...
<head>
    ...
    <link rel="stylesheet" href="style/srtmasuk.css">
    <link href='https://unpkg.com/boxicons@2.0.9/css/boxicons.min.css' rel='stylesheet'>
    <title>Laporan Surat Masuk - Arsip Digital (Kepala Kantor)</title>
</head>
<body>
    <div class="sidebar">
                ...
                <div class="data">
                        <div class="card">
                            ...
                            <div class="card-category">
                                ...
                                <select id="bulan" name="bolan" onchange="bulann(this.value);">
    ...
    <script type="text/javascript">
        ...
        function bulann(str) {
            ...
            xmlhttp.open("GET","getsrtmasuk.php?thn="+thn.value+"&bln="+str,true);
            xmlhttp.send();
            }
        }
        ...
        function submit(){
            ...
            window.location.href = 'srtmasuk-print.php?bulan='+bln.value+'&tahun='+thn.value;
            }
        }
    </script>
