...
<head>
    ...
    <link rel="stylesheet" href="style/srtkptsn.css">
    <link href='https://unpkg.com/boxicons@2.0.9/css/boxicons.min.css' rel='stylesheet'>
    <title>Laporan Surat Keputusan - Arsip Digital (Kepala Kantor)</title>
</head>
<body>
    <div class="sidebar">
    ...
    <script type="text/javascript">
        ...
        function bulan(str) {
            ...
            xmlhttp.open("GET","getsrtkptsn.php?thn="+thn.value+"&bln="+str,true);
            xmlhttp.send();
            }
        }
        ...
        function submit(){
            ...
            window.location.href = 'srtkptsn-print.php?bulan='+bln.value+'&tahun='+thn.value;
            }
        }
    </script>
                            <div class="card-body">
