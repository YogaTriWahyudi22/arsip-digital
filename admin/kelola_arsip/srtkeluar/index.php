...
<head>
    ...
    <title>Surat Keluar - Arsip Digital (Admin)</title>
</head>
<body>
    <div class="sidebar">
    ...
    <?php
        $no = 1;
        // Pengambilan Data dari Database MySQL
        $sql = $conn->prepare("SELECT * FROM surat_keluar");
        $sql->execute();
        $data = $sql->fetchAll();
    ...
    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="edit.php?id=<?php echo $value['id_surat_keluar'] ?>">
                                                <button class="btnlht" title="Edit"><i class='bx bxs-edit'></i></button></a>
                                                <a href="hapus.php?id=<?php echo $value['id_surat_keluar'] ?>"
