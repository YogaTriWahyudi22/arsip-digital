...
<head>
    ...
    <title>Surat Keterangan - Arsip Digital (Admin)</title>
</head>
<body>
    <div class="sidebar">
                ...
                <div class="data">
                        <div class="card">
                            <div class="card-header">
                                <h3>
                                    Data <?php echo $sqli['jenis_keterangan'] ?>
                                </h3>
                                <a href="tambah.php?id=<?php echo $_GET['id'] ?>"><label name="back" class="btnnn">Tambah Data
    ...
    <?php
        $no = 1;
        // Pengambilan Data dari Database MySQL
        $sql = $conn->prepare("SELECT * FROM surat_keterangan WHERE id_jenis_keterangan = '$_GET[id]'");
        $sql->execute();
        $data = $sql->fetchAll();
    ...
    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="edit.php?id=<?php echo $value['id_surat_keterangan'] ?>">
                                                <button class="btnlht" title="Edit"><i class='bx bxs-edit'></i></button></a>
                                                <a href="hapus.php?id=<?php echo $value['id_surat_keterangan'] ?>"
