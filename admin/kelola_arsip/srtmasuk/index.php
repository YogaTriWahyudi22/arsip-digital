...
<head>
    ...
    <title>Surat Masuk - Arsip Digital (Admin)</title>
</head>
<body>
    <div class="sidebar">
    ...
    <?php
        $no = 1;
        // Pengambilan Data dari Database MySQL
        $sql = $conn->prepare("SELECT * FROM surat_masuk");
        $sql->execute();
        $data = $sql->fetchAll();
    ...
    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="edit.php?id=<?php echo $value['id_surat_masuk'] ?>">
                                                <button class="btnlht" title="Edit"><i class='bx bxs-edit'></i></button></a>
                                                <a href="hapus.php?id=<?php echo $value['id_surat_masuk'] ?>"
