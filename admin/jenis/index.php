...
<head>
    ...
    <title>Jenis Keterangan - Arsip Digital (Admin)</title>
</head>
<body>
    <div class="sidebar">
    ...
    ?>
                                        <tr>
                                            <td><?php echo $no; ?></td>
                                            <td><?php echo $value['jenis_keterangan']; ?></td>
                                            <td>
                                                <a href="edit.php?id=<?php echo $value['id_jenis_keterangan'] ?>">
                                                <button class="btnlht" title="Edit"><i class='bx bxs-edit'></i></button></a>
                                                <a href="hapus.php?id=<?php echo $value['id_jenis_keterangan'] ?>"
